...
Required: Before retrieval/model calls, check IDs/types/interfaces, no isolated nodes, valid links, non-L2 IPv4 prefixes, known configuration shapes/references and acyclic Ansible dependencies. Preserve supplied fields after readiness passes.
